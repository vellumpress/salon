...
- Chamber reader for all **858 local binds** (texts + openings stay in `src/lib/catalog/texts` and `src/lib/catalog/openings`)
...
858 locally bound works with full text. Years and rights notes come from the V4 shelf. English-off ids stay unlistable as full-text reads.
