...
const WORK_PLACE: Record<string, WorkPlace> = {
  ...
  "the-moon-and-sixpence": { label: "England → Tahiti", region: "gb" },
  "my-brilliant-career": { label: "Australia — Possum Gully", region: "au" },
  "the-plumed-serpent": { label: "Mexico City", region: "mx" },
  "the-red-room": { label: "Stockholm", region: "se" },
  "the-green-carnation": { label: "London — Piccadilly", region: "gb" },
  "hajji-baba": { label: "Ispahan", region: "ir" },
  "the-master-of-ballantrae": { label: "Durrisdeer", region: "gb" },
  "a-set-of-six": { label: "Chile", region: "cl" },
  "the-hill-of-dreams": { label: "Wales — Gwent", region: "gb" },
  "the-story-of-an-african-farm": { label: "Karoo", region: "za" },
  "the-imperialist": { label: "Elgin, Ontario", region: "ca" },
  "mogens-and-other-stories": { label: "Denmark", region: "dk" },
  "the-immoralist": { label: "France", region: "fr" },
  "where-angels-fear-to-tread": { label: "Charing Cross → Tuscany", region: "it" },
  "the-man-of-property": { label: "Stanhope Gate", region: "gb" },
  "theresa-raquin": { label: "Pont Neuf", region: "fr" },
  ...
  "brazilian-tales": { label: "Rio — Guarda-Velha", region: "br" },
  ...
  "pointed-roofs": { label: "Hanover", region: "de" },
  "the-rise-of-silas-lapham": { label: "Boston", region: "us" },
  indiana: { label: "Brie", region: "fr" },
  ...
  kim: { label: "Lahore — Wonder House", region: "in" },
