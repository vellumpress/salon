...
- Chamber reader for all **839 local binds** (texts + openings stay in `src/lib/catalog/texts` and `src/lib/catalog/openings`)
...
839 locally bound works with full text. Years and rights notes come from the V4 shelf. English-off ids stay unlistable as full-text reads.
