...
const BLURBS: Record<string, string> = {
  ...
  "dorian-gray-shanghai":
    "A Bund portrait that ages while Du Yan does not—Shanghai clubs, a fruit-knife, the river unarchiving.",
  "anna-karenina-milan":
  ...
  "pride-prejudice-buenos-aires":
    "Recoleta manners as municipal law: Elena Benítez watches Buenos Aires arrange marriages along Alvear.",
  "dracula-istanbul":
  ...
  "tess-lisbon":
    "A spent name, a Tagus-side villa, and purity police that finish what desire began.",
